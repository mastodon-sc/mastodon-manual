...
The spot that has the focus is painted with a thick and dashed contour (Figure~\ref{fig:FocusedSpots}, left). 
...
\begin{figure}
    ...
    \caption{Focused spots are painted in TrackScheme (left) and in BDV (right) views as ellipses with a thick, dashed-contour.}
...
A red box will paint a box 
Release it when it contains the part of the tracks you want to select, and they should now be painted in green.
...
\keys{Shift+click} on a spot or a link toggles it in the selection.
